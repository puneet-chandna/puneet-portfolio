  ...
  return (
    <section className="section hero" id="home">
      ...
      >
        ...
        >
          <a href={socialLinks.github} target="_blank" rel="noopener noreferrer" title="GitHub" aria-label="GitHub">
          ...
          <a href={`mailto:${socialLinks.email}`} title="Email" aria-label="Email">
            <svg aria-hidden="true" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
